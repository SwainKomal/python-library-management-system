...
mypass = "**** add ur db_name"
mydatabase = "****** add ur db_pass"

# Enter Table Names here
empTable = "emp_tab"  # Employee Table
stuTable = "stu_tab"  # Student Table
...
def empMenu():
    ...
    Canvas1.config(bg="#f7f1e3", width=newImageSizeWidth,
    ...
    btn1 = Button(root, text="Add Book Details",
                  bg='black', fg='white', command=addBooks)
    ...
    btn4 = Button(root, text="Search Book", bg='black',
                  fg='white', command=searchBook)
    btn4.place(relx=0.28, rely=0.6, relwidth=0.45, relheight=0.1)

    btn5 = Button(root, text="Issue Book to Student",
                  bg='black', fg='white', command=issueBook)
    btn5.place(relx=0.28, rely=0.7, relwidth=0.45, relheight=0.1)

    backBtn = Button(root, text="<  BACK", bg='#455A64',
                     fg='white', command=Employee)
...
def stuMenu():
    ...
    Canvas1.config(bg="#dff9fb", width=newImageSizeWidth,
                   height=newImageSizeHeight)
    Canvas1.pack(expand=True, fill=BOTH)
...
def gettingEmpDetails():
    ...
    try:
        if (type(int(EmpId)) == int):
            ...
            messagebox.showinfo(
                "Invalid Value", "Employee ID should be an integer")
            return
    except:
        messagebox.showinfo(
            "Invalid Value", "Employee ID should be an integer")
    ...
    try:
        if (type(float(sal)) == float or type(int(sal)) == int):
            ...
            messagebox.showinfo(
                "Invalid Value", "Salary should be a float/int value")
            return
    except:
        messagebox.showinfo(
            "Invalid Value", "Salary should be a float/int value")
...
def gettingStuDetails():
    ...
    try:
        if (type(int(Rollno)) == int):
            ...
            messagebox.showinfo(
                "Invalid Value", "Roll number should be an integer")
            return
    except:
        messagebox.showinfo(
            "Invalid Value", "Roll number should be an integer")
        ...
        try:
            ...
            if(getLoginID == login and getName == name):
                ...
                messagebox.showerror(
                    "Failure", "Can't log in, check your credentials")
        except:
...
def EmpRegister():
    ...
    # Submit Button
    SubmitBtn = Button(root, text="SUBMIT", bg='#264348',
                       fg='white', command=gettingEmpDetails)
...
def studentRegister():
    ...
    # Submit Button
    SubmitBtn = Button(root, text="SUBMIT", bg='#264348',
                       fg='white', command=gettingStuDetails)
    SubmitBtn.place(relx=0.28, rely=0.9, relwidth=0.18, relheight=0.08)
...
def Employee():
    ...
    Canvas1.config(bg="#FFF9C4", width=newImageSizeWidth,
                   height=newImageSizeHeight)
    Canvas1.pack(expand=True, fill=BOTH)
    ...
    btn1 = Button(root, text="Register", bg='black',
                  fg='white', command=EmpRegister)
    ...
    btn3 = Button(root, text="Quit", bg='#455A64',
...
def Student():
    ...
    btn1 = Button(root, text="Register", bg='black',
                  fg='white', command=studentRegister)
    btn1.place(relx=0.28, rely=0.3, relwidth=0.2, relheight=0.1)
