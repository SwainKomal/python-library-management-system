...
issueTable = "issue_tab"  # Issue Table
bookTable = "book_tab"  # Book Table
...
def issue():
    ...
    Label(labelFrame, text="%-20s%-30s%-30s" % ('BID', 'Issued To',
                                                'Issued By'), bg='black', fg='white').place(relx=0.27, rely=0.1)
    Label(labelFrame, text="---------------------------------------------------------",
          bg='black', fg='white').place(relx=0.2, rely=0.2)

    issueSql = "insert into "+issueTable + \
        " values ('"+bid+"','"+issueto+"','"+issueby+"')"
    ...
    try:
        ...
        con.commit()
        for i in cur:
            Label(labelFrame, text="%-20s%-30s%-30s" %
                  (i[0], i[1], i[2]), bg='black', fg='white').place(relx=0.27, rely=y)
            y += 0.1
            print(i)
    except:
        messagebox.showinfo(
...
def issueBook():
    ...
    lb2 = Label(labelFrame, text="Issued To(rollno) : ",
                bg='black', fg='white')
