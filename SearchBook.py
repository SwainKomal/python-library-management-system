...
def search():
    ...
    Label(labelFrame, text="%-10s%-30s%-20s%-30s%-20s" % ('BID', 'Title', 'Subject',
    ...
    try:
        ...
        con.commit()
        for i in cur:
            Label(labelFrame, text="%-10s%-30s%-20s%-30s%-20s" %
    ...
    quitBtn = Button(root, text="< Back", bg='#455A64',
